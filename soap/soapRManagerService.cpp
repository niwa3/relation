/* soapRManagerService.cpp
   Generated by gSOAP 2.8.16 from relationsoap.h
...
static int serve___ns1__data(RManagerService*);

int RManagerService::dispatch()
{	soap_peek_element(this);
	if (!soap_match_tag(this, this->tag, "req"))
		return serve___ns1__data(this);
	return this->error = SOAP_NO_METHOD;
}

static int serve___ns1__data(RManagerService *soap)
{	struct __ns1__data soap_tmp___ns1__data;
	_ns1__dataRS res;
	res.soap_default(soap);
	soap_default___ns1__data(soap, &soap_tmp___ns1__data);
	if (!soap_get___ns1__data(soap, &soap_tmp___ns1__data, "-ns1:data", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->data(soap_tmp___ns1__data.req, res);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = "http://schems.xmlsoap.org/soap/encoding/";
